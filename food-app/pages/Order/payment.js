  ...
  const total = () => (
    <Box marginTop={5} >
      ...
      <Flex paddingBottom={3}>
        <Text width={150} fontSize='sm' fontWeight={600}> Delivery Fee</Text>
        <Spacer/>
        <Text width={50} textAlign="right" > $20</Text>
      </Flex>
      <Spacer/>
      <Flex>
        <Text width={150} fontSize='sm' fontWeight={600}>Subtotal</Text>
        <Spacer/>
        <Text width={50} textAlign="right"> $520</Text>
      </Flex>
      </Box>
  ...
  return (
    ...
    <Box padding={10} paddingBottom={3}>
      ...
      {total()}
       ...
       <Box color={"#000000"} backgroundColor="#000000" height={"0.3"} borderColor="#000000"  ></Box>
      
      <Box>
      <Flex padding={10} paddingTop={3} >
        <Text width={150} fontSize='sm' fontWeight={600}> Total</Text>
        <Spacer/>
        <Text width={50} textAlign="right" fontSize='xl' fontWeight={700} > $540</Text>
      </Flex>
      </Box>
